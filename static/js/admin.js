...
function showNotification(message, type = 'info') {
    ...
    notification.className = `admin-notification fixed top-4 right-4 z-50 px-6 py-3 rounded-lg shadow-lg text-white max-w-sm transform transition-all duration-300 ${
